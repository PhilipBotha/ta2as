...
const RegStruct regslist[] = {
        {"ah", 1},  {"al", 1},  {"ax", 2},  {"bh", 1},  {"bl", 1},  {"bp", 2},  {"bx", 2},  {"ch", 1},
        {"cl", 1},  {"cr0", 4}, {"cr1", 4}, {"cr2", 4}, {"cr3", 4}, {"cr4", 4}, {"cx", 2},  {"dh", 1},
        {"di", 2},  {"dl", 1},  {"dr0", 4}, {"dr1", 4}, {"dr2", 4}, {"dr3", 4}, {"dr4", 4}, {"dr5", 4},
        {"dr6", 4}, {"dr7", 4}, {"dx", 2},  {"eax", 4}, {"ebp", 4}, {"ebx", 4}, {"ecx", 4}, {"edi", 4},
...
const ModStruct wrdmods[] = {
        {"=", eqSgnReshuffle, 1}, {"dosseg", NULL, 0},
        {"end", NULL, 0},         {"equ", equReshuffle, 1},
        {"extrn", NULL, 0},       {"ideal", NULL, 0},
...
const ReplaceStruct wrdreplace[] = {
        {"align", ".align"},  {"cbw", "cbtw"},    {"cdq", "cltd"},    {"cmpsd", "cmpsl"},
        {"codeseg", ".text"}, {"cwd", "cwtd"},    {"cwde", "cwtl"},   {"dataseg", ".data"},
        {"db", ".byte"},      {"dd", ".int"}, // may also be float
        ...
        {"dw", ".short"},     {"insd", "insl"},   {"lodsd", "lodsl"}, {"movsd", "movsl"},
...
int operandChange2Atnt(Operand *op, short com_flags) {
    ...
    } else if (isdigit(*opg)) // if we have immediate numeric value
    {
        memmove(opg + 1, opg, strlen(opg) + 1);
        *opg = '$';
    } else { // then it must be some variable
        memmove(opg + 1, opg, strlen(opg) + 1);
        *opg = '$';
    }
